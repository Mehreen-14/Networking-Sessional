...
NS_LOG_COMPONENT_DEFINE("1905078");
void
...
main(int argc, char* argv[])
{
    ...
    double txpDistance = ((double)coverage)*5.0;
    ...
    //                               DoubleValue(7.0),
    //                               "MinY",
    //                               DoubleValue(((numNodes/2)*3.0)/2.0),
    //                               "DeltaX",
    //                               DoubleValue(3.0),
    //                               "DeltaY",
    //                               DoubleValue(3.0),
   ...
   // mobility.SetMobilityModel("ns3::ConstantPositionMobilityModel");
    ...
    for (u_int32_t i = 0; i < (numNodes/2); i++)
    {
        ...
        //uint32_t senderIndex = i % numNodes;
        //uint32_t receiverIndex = i % numNodes;
   ...
   // std::cout<<numNodes<<std::endl;
    ...
    //std::cout << "\nPacket Delivery Ratio: "<<packetdelratio<<std::endl;
